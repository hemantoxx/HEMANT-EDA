...
def display_individual_feature_distribution(df,num_columns):
    ...
    st.write("#### 1.1 Understanding Numerical Features")
    ...
    st.subheader("1.2 Distribution Plots")
...
def feature_exploration_numerical_variables(df,num_columns):
    ...
    if len(selected_features) < 2:
        ...
        st.subheader("4.2 Explore Relationships Between Features")
...
# Group by the selected categorical column and calculate the mean of the numerical column
    ...
    st.subheader("5.2 Relationship between Categorical and Numerical Variables")
